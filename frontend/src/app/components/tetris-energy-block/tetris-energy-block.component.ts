...
@Component({
  selector: 'app-tetris-energy-block',
  templateUrl: './tetris-energy-block.component.html',
  styleUrls: ['./tetris-energy-block.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TetrisEnergyBlockComponent implements OnInit, OnDestroy {
