...
export class BlockComponent implements OnInit, OnDestroy {
              ...
              .pipe(
                switchMap((hash) => {
                  ...
                  this.location.replaceState(
                    this.router.createUrlTree([(this.network ? '/' + this.network : '') + '/hashstrikes/block/', hash]).toString()
                  );
  ...
  navigateToPreviousBlock() {
    ...
    this.router.navigate([this.relativeUrlPipe.transform('/hashstrikes/block/'),
