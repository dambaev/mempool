...
@Component({
  selector: 'app-energy-detail-v2',
  templateUrl: './energy-detail-v2.component.html',
  styleUrls: ['./energy-detail-v2.component.scss']
})
export class EnergyDetailV2Component implements OnInit, OnDestroy {
  network = '';
  fromBlock: Block;
  toBlock: Block;
  blockHeight: number;
